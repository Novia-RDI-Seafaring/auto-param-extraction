...
class JsonExtractor:
    ...
    def __init__(self, intermediate_format: BasicFormatHandler, chunks_max_characters=1000, chunk_overlap=2,  n_rounds=1, model='gpt-4o-mini', model_temp=0.3, api_key: str = None) -> None:
